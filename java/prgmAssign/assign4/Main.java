...
public class Main {
	...
	Point controlPt = new Point(Integer.parseInt(args[1]),
				    Integer.parseInt(args[2])), shiftPt;
	...
	if (args.length == 5) {
	    shiftPt = new Point(Integer.parseInt(args[3]),
				Integer.parseInt(args[4]));			 
	}
	else {
	    shiftPt = new Point(width / 2, height / 2);
	}
	...
	ImageTransform imageTransform = new ImageTransform(pixels, width, height, controlPt, shiftPt);
